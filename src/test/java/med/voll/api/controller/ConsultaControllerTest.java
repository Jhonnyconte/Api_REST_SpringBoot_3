...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver 400 quando informações estão invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver 200 quando informações estão validas")
    @WithMockUser
    void agendar_cenario2() throws Exception {
        var data = LocalDateTime.now().plusHours(1);
        var especialidade = Especialidade.CARDIOLOGIA;
        var dadosDetalhamentos = new DadosDetalhamentoConsultas(null, 2l, 5l, data);
